  ...
  return (
    <>
      <div className="bg-[#1c1f20] w-full min-h-screen h-full text-white flex flex-col">
        ...
        <div className="bg-[#181a1b] w-full mt-10 flex flex-col items-center text-3xl p-10">
          <div>
            <h1>Ferramentas ilimitadas e grátis para todos</h1>
          </div>

          <div className="flex flex-wrap">
            <div className="w-[420px] h-[202px] text-base mt-10">
              <h2 className="text-3xl">Otimizar imagens</h2>
              <h3 className="text-xl mt-2 text-gray-300">
                Comprima várias imagens de uma vez e mantenha a qualidade de
                todas elas, assim podendo economizar espaços!
              </h3>
            </div>

            <div className="max-w-[420px] max-h-[202px] w-full flex flex-wrap h-full text-base mt-10">
              <h2 className="text-3xl">Converter imagens</h2>
              <h3 className="text-xl mt-2 text-gray-300">
                Converta várias imagens de uma vez e economize seu tempo, rápido
                e facil para todos!
              </h3>
            </div>
          </div>
